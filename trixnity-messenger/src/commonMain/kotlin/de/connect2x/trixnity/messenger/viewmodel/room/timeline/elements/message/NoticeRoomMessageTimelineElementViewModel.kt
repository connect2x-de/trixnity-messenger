...
interface NoticeRoomMessageTimelineElementViewModelFactory : TimelineElementViewModelFactory<TextBased.Notice> {
    override fun create(
        ...
        NoticeRoomMessageTimelineElementViewModelImpl(viewModelContext, content, roomId, onOpenMention)
...
class NoticeRoomMessageTimelineElementViewModelImpl(
    ...
    RoomMessageTimelineElementViewModel.TextBased.Notice,
    RoomMessageTimelineElementViewModelImpl<TextBased.Notice>(viewModelContext, content, roomId, onOpenMention)
