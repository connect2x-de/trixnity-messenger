...
object ImageSizeComputations {
    fun getHeight(width: Int, maxWidth: Int, height: Int, maxHeight: Int): Int {
    ...
    fun getWidth(width: Int, maxWidth: Int, height: Int, maxHeight: Int): Int {
        val imageFitsBounds = height <= maxHeight && width <= maxWidth
        if (imageFitsBounds) {
            return width
        }
