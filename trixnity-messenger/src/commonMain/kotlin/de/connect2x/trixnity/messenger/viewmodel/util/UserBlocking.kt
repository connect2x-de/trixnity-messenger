...
class UserBlockingImpl : UserBlocking {
    ...
    override suspend fun blockUser(
        ...
        mutex.withLock {
            withTimeoutOrNull(5.seconds) {
                ...
                matrixClient.user
                    .getAccountData<IgnoredUserListEventContent>()
                    .map { it ?: IgnoredUserListEventContent(emptyMap()) }
                    .first()
                    .ignoredUsers
                    .let { ignoredUsers ->
    ...
    override suspend fun unblockUser(
        ...
        mutex.withLock {
            withTimeoutOrNull(5.seconds) {
                matrixClient.user.getAccountData<IgnoredUserListEventContent>().first()?.ignoredUsers?.let {
                    ignoredUsers ->
