...
class UiaStepMsisdnViewModelImpl(viewModelContext: ViewModelContext, private val onCancel: () -> Unit) :
    UiaStepMsisdnViewModel, ViewModelContext by viewModelContext {
    override val error: StateFlow<String?> =
        flowOf(i18n.uiaFallbackNotSupported(AuthenticationType.Msisdn))
