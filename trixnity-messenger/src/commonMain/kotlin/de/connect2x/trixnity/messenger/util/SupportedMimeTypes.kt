...
object SupportedMimeTypes {
     ...
     *
     * Supported formats are JPEG, PNG, BMP, WebP, and GIF. Note that `decodeToImageBitmap` may only fully support
     * JPEG, PNG, BMP, and GIF (statically via the first frame).
     */
