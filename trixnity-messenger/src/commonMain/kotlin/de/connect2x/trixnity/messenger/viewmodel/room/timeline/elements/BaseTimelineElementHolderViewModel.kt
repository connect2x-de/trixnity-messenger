...
sealed interface BaseTimelineElementHolderViewModel {
    ...
    /**
     * Indicates that the message is the first in a sequence or consecutive group of messages from the same user. This
     * can be used to e.g. render a chat bubble tail on the first message of the sequence only.
     */
    ...
    /**
     * Whether this element should render a big gap (e.g. due to a time gap or sender change) which is preceding this
     * element in the timeline.
     */
    val showBigGapBefore: StateFlow<Boolean?>

    /**
     * Errors that occurred during sending of this event, either during initial sending or when replacing previous
     * events
     */
