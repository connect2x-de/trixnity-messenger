...
abstract class I18n(languages: Languages, settings: MatrixMessengerSettingsHolder, getSystemLang: GetSystemLang) :
    ...
    fun eventRoomTopicChange(username: String, groupOrChat: String, from: String, roomTopic: String) = translate {
        EN - "$username has changed the topic of $groupOrChat ${from}to '$roomTopic'"
        DE - "$username hat die Beschreibung $groupOrChat ${from}zu '$roomTopic' geändert"
    }
