...
class UiaStepEmailIdentityViewModelImpl(viewModelContext: ViewModelContext, private val onCancel: () -> Unit) :
    UiaStepEmailIdentityViewModel, ViewModelContext by viewModelContext {
    override val error: StateFlow<String?> =
        flowOf(i18n.uiaFallbackNotSupported(AuthenticationType.EmailIdentity))
            .stateIn(
                coroutineScope,
