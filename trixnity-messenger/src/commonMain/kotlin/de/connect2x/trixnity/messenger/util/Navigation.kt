...
suspend fun <C : Any> StackNavigator<C>.navigateSuspending(transformer: (stack: List<C>) -> List<C>) =
...
/** @see [com.arkivanov.decompose.router.stack.navigate] */
fun <C : Any> StackNavigator<C>.launchNavigate(scope: CoroutineScope, transformer: (stack: List<C>) -> List<C>) =
...
suspend fun <C : Any> StackNavigator<C>.replaceCurrentSuspending(configuration: C, onComplete: () -> Unit = {}) =
    withContext(Dispatchers.Main.immediate) {
...
suspend fun <C : Any> StackNavigator<C>.replaceAllSuspending(vararg configurations: C, onComplete: () -> Unit = {}) =
    withContext(Dispatchers.Main.immediate) {
...
/** @see [com.arkivanov.decompose.router.stack.replaceCurrent] */
fun <C : Any> StackNavigator<C>.launchReplaceAll(scope: CoroutineScope, configuration: C, onComplete: () -> Unit = {}) =
    scope.launch(Dispatchers.Main.immediate) {
...
suspend fun <C : Any> StackNavigator<C>.pushSuspending(configuration: C, onComplete: () -> Unit = {}) =
    withContext(Dispatchers.Main.immediate) {
...
/** @see [com.arkivanov.decompose.router.stack.push] */
@OptIn(DelicateDecomposeApi::class)
fun <C : Any> StackNavigator<C>.launchPush(scope: CoroutineScope, configuration: C, onComplete: () -> Unit = {}) =
    scope.launch(Dispatchers.Main.immediate) {
        log.trace { "push configuration $configuration" }
        push(configuration, onComplete)
    }
...
suspend fun <C : Any> StackNavigator<C>.popSuspending(onComplete: (isSuccess: Boolean) -> Unit = {}) =
    withContext(Dispatchers.Main.immediate) {
...
/** @see [com.arkivanov.decompose.router.stack.pop] */
fun <C : Any> StackNavigator<C>.launchPop(scope: CoroutineScope, onComplete: (isSuccess: Boolean) -> Unit = {}) =
    scope.launch(Dispatchers.Main.immediate) {
        log.trace { "pop current configuration" }
        pop(onComplete)
    }
...
suspend fun <C : Any> StackNavigator<C>.popWhileSuspending(predicate: (C) -> Boolean) =
    withContext(Dispatchers.Main.immediate) {
...
/** @see [com.arkivanov.decompose.router.stack.popWhile] */
fun <C : Any> StackNavigator<C>.launchPopWhile(scope: CoroutineScope, predicate: (C) -> Boolean) =
    scope.launch(Dispatchers.Main.immediate) {
        log.trace { "popWhile current configuration" }
        popWhile(predicate)
    }
...
suspend fun <C : Any> StackNavigator<C>.bringToFrontSuspending(configuration: C, onComplete: () -> Unit = {}) =
    withContext(Dispatchers.Main.immediate) {
