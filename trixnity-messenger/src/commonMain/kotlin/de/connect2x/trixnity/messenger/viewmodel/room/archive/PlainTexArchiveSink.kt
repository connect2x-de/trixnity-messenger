...
class PlainTexArchiveSink(
    ...
    override suspend fun processArchive(archiveStateCallback: (ArchiveSinkState) -> Unit) {
        ...
        if (sinkConfig !is GetPlainTextArchiveSinkConfig) {
            ...
            matrixClient.room.getTimelineEvents(
                ...
                .onCompletion { cause ->
                    if (cause != null) {
                        ...
                        log.debug { "Sink successfully complete for $roomId" }
    ...
    private fun createFileName(plainTextArchiveSinkConfig: GetPlainTextArchiveSinkConfig, roomId: RoomId): String {
