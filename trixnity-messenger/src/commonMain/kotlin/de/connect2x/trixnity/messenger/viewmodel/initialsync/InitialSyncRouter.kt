...
class InitialSyncRouter(private val viewModelContext: ViewModelContext) {
    companion object {
    ...
    private fun createInitialSyncChild(initialSyncConfig: Config, componentContext: ComponentContext): Wrapper =
    ...
    sealed class Config {
        ...
        @Serializable data object Undefined : Config()

        @Serializable data object Sync : Config()
    }
}
