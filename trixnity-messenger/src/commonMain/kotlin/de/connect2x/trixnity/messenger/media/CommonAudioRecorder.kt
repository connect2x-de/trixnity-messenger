 ...
 */
object CommonAudioRecorder {
    private val log: Logger = Logger("de.connect2x.trixnity.messenger.media.InternalAudioRecorder")
    ...
    fun complete(commonState: CommonState): CommonState {
    ...
    fun close(commonState: CommonState): CommonState {
     ...
     */
    fun Flow<CommonState>.sampleToPublicState(clock: Clock): Flow<AudioRecorder.State> {
    ...
    fun withCatchCallbacks(recordingState: CommonState.Recording): CommonState.Recording {
