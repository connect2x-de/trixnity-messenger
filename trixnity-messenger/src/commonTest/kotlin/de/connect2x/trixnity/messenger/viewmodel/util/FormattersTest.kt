...
class FormattersTest {
    val clock = mock<Clock> { every { now() } returns Instant.parse("2022-03-10T19:00:00.000Z") }

    @Test
    fun `show the time when date is today`() {
        formatTimestamp(Instant.parse("2022-03-10T03:12:00.000Z"), clock, TimeZone.of("CET")) shouldBe
            "04:12" // UTC -> CET
    }
