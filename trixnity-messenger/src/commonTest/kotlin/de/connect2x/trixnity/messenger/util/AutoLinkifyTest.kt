...
class AutoLinkifyTest {
    private fun parseLinks(content: String): HtmlNode.HtmlElement =
        AutoLinkifyVisitor.process(HtmlNode.HtmlElement("#root", emptyMap(), listOf(HtmlNode.TextContent(content))))
    ...
    fun linkifiesLinksInText() {
        assertEquals(
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                ...
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "https://example.com/"),
                                    listOf(HtmlNode.TextContent("https://example.com/")),
                                ),
                                HtmlNode.TextContent(
            ...
            actual =
                parseLinks(
                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. https://example.com/ Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."
                ),
        )
    }
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                ...
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "matrix:u/user:acme.com"),
                                    listOf(HtmlNode.TextContent("@user:acme.com")),
                                ),
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                ...
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "matrix:r/awesome-room:acme.com"),
                                    listOf(HtmlNode.TextContent("#awesome-room:acme.com")),
                                ),
                                HtmlNode.TextContent("! How are you?"),
                            ),
                        )
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                ...
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "matrix:u/user:acme.com?action=chat"),
                                    listOf(HtmlNode.TextContent("@user:acme.com")),
                                ),
                                HtmlNode.TextContent("! How are you?"),
                            ),
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                ...
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "matrix:u/alice:example.org"),
                                    listOf(HtmlNode.TextContent("@alice:example.org")),
                                ),
                                HtmlNode.TextContent("! How are you?"),
                            ),
                        )
                                ...
                                listOf(
                                    HtmlNode.HtmlElement(
                                        ...
                                        attributes =
                                            mapOf(
                                                "href" to
                                                    "matrix:roomid/WvOltebgJfkgHzhfpW:matrix.org/e/KoEcMwZKqGpCeuMjAmt9zvmWgO72f7hDFkvfBMS479A?via=matrix.org&via=imbitbu.de"
                                            ),
                                        children =
                                            listOf(
                                                HtmlNode.TextContent(
                                                    content = "\$KoEcMwZKqGpCeuMjAmt9zvmWgO72f7hDFkvfBMS479A"
                                                )
                                            ),
                                    ),
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                ...
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "matrix:u/user2:acme.com"),
                                    listOf(HtmlNode.TextContent("@user2:acme.com")),
                                ),
                                HtmlNode.TextContent("?"),
                            ),
                        )
                        ...
                        listOf(
                            HtmlNode.HtmlElement(
                                ...
                                listOf(
                                    ...
                                    HtmlNode.HtmlElement(
                                        "a",
                                        mapOf("href" to "https://tammy.connect2x.de/en-us/"),
                                        listOf(HtmlNode.TextContent("https://tammy.connect2x.de/en-us/")),
                                    ),
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "https://matrix.org"),
                                    listOf(HtmlNode.TextContent("https://matrix.org")),
                                )
                            ),
                        )
                    ),
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "https://duckduckgo.com/?q=html+escaping+ampersand&amp;ia=web"),
                                    listOf(
                                        HtmlNode.TextContent(
                                            "https://duckduckgo.com/?q=html+escaping+ampersand&amp;ia=web"
                                        )
                                    ),
                                )
                            ),
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "https://exampleformytest.com/bla;blubb"),
                                    listOf(HtmlNode.TextContent("https://exampleformytest.com/bla;blubb")),
                                )
                            ),
                        )
                    ),
                        ...
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                HtmlNode.HtmlElement(
                                    ...
                                    listOf(
                                        HtmlNode.TextContent(
                                            "https://osmand.net/map/?pin=50.89774,13.69089#19/51.05483/13.74711"
                                        )
                                    ),
                                )
                            ),
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                ...
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "https://graphemica.com/"),
                                    listOf(HtmlNode.TextContent("https://graphemica.com/")),
                                ),
                                HtmlNode.TextContent("!"),
                            ),
                        )
                    ...
                    listOf(
                        HtmlNode.HtmlElement(
                            ...
                            listOf(
                                ...
                                HtmlNode.HtmlElement(
                                    "a",
                                    mapOf("href" to "https://en.wikipedia.org/wiki/Matrix_(protocol)"),
                                    listOf(HtmlNode.TextContent("https://en.wikipedia.org/wiki/Matrix_(protocol)")),
                                ),
