...
class HkdfSha256Test {
    ...
    fun rfc5869testCase1() = rfc5869testCase(
        ...
        keyBytesLength = 42,
        expectedResult = "3cb25f25faacd57a90434f64d0362f2a2d2d0a90cf1a5a4c5db02d56ecc4c5bf34007208d5b887185865"
    )
    ...
    fun rfc5869testCase2() = rfc5869testCase(
        ...
        keyBytesLength = 82,
        expectedResult = "b11e398dc80327a1c8e7f78c596a49344f012eda2d4efad8a050cc4c19afa97c59045a99cac7827271cb41c65e590e09da3275600c2f09b8367793a9aca3db71cc30c58179ec3e87c14c01d5c1f3434f1d87"
    )
    ...
    fun rfc5869testCase3() = rfc5869testCase(
        ...
        infoHex = "",
        keyBytesLength = 42,
        expectedResult = "8da4e775a563c18f715f802a063c5a31b8a11f5c5ee1879ec3454e5f3c738d2d9d201395faa4b61a96c8"
    )
}
