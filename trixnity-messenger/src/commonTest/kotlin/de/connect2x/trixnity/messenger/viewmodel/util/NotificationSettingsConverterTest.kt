...
class NotificationSettingsConverterTest {
    ...
    fun `parse push rules 1`() = runTest {
        ...
        pushRulSet.toNotificationSettings() shouldBe
            AccountNotificationSettings(
                defaultLevel = AccountNotificationSettings.DefaultLevel.ROOM,
                sound = AccountNotificationSettings.Sound(room = false, dm = true, mention = true, call = true),
                activity = Activity(invite = true, status = true, notice = false),
                mention = AccountNotificationSettings.Mention(user = true, room = true, keyword = true),
    ...
    fun `parse push rules 2`() = runTest {
        ...
        pushRulSet.toNotificationSettings() shouldBe
            AccountNotificationSettings(
                defaultLevel = AccountNotificationSettings.DefaultLevel.DM,
                sound = AccountNotificationSettings.Sound(room = false, dm = false, mention = false, call = false),
                activity = Activity(invite = false, status = false, notice = false),
    ...
    fun `parse push rules 3`() = runTest {
        ...
        pushRulSet.toNotificationSettings() shouldBe
            AccountNotificationSettings(
                defaultLevel = AccountNotificationSettings.DefaultLevel.NONE,
                sound = AccountNotificationSettings.Sound(room = false, dm = false, mention = true, call = true),
                activity = Activity(invite = true, status = true, notice = true),
                mention = AccountNotificationSettings.Mention(user = true, room = true, keyword = false),
                keywords = setOf(),
            )
    }
    ...
    fun `parse NotificationSettings 1`() = runTest {
        val accountNotificationSettings =
            AccountNotificationSettings(
                defaultLevel = AccountNotificationSettings.DefaultLevel.ROOM,
                sound = AccountNotificationSettings.Sound(room = true, dm = true, mention = true, call = true),
                activity = Activity(invite = true, status = true, notice = false),
                mention = AccountNotificationSettings.Mention(user = true, room = true, keyword = true),
                keywords = setOf("keyword1", "keyword2"),
            )
    ...
    fun `parse NotificationSettings 3`() = runTest {
        val accountNotificationSettings =
            AccountNotificationSettings(
                defaultLevel = AccountNotificationSettings.DefaultLevel.NONE,
                sound = AccountNotificationSettings.Sound(room = true, dm = false, mention = true, call = true),
                activity = Activity(invite = true, status = true, notice = true),
                mention = AccountNotificationSettings.Mention(user = true, room = true, keyword = false),
                keywords = setOf(),
            )
