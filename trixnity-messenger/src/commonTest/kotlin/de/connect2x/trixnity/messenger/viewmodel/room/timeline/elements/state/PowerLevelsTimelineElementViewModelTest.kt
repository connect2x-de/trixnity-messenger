...
class PowerLevelsTimelineElementViewModelTest {
    ...
    fun `ban change results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(), PowerLevelsEventContent(ban = 123L))
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    fun `invite change results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(), PowerLevelsEventContent(invite = 123L))
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    fun `kick change results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(), PowerLevelsEventContent(kick = 123L))
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    fun `redact change results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(), PowerLevelsEventContent(redact = 123L))
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    fun `eventsDefault =  change results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(), PowerLevelsEventContent(eventsDefault = 123L))
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    fun `stateDefault =  change results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(), PowerLevelsEventContent(stateDefault = 123L))
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    fun `usersDefault =  change results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(), PowerLevelsEventContent(usersDefault = 123L))
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    fun `event removal results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(events = mapOf(testEventType to 42L)), PowerLevelsEventContent())
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    fun `event added results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(), PowerLevelsEventContent(events = mapOf(testEventType to 42L)))
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    fun `user removal results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(users = mapOf(alice to 42L)), PowerLevelsEventContent())
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    fun `user added results in message`() = runTest {
        val model = testModel(PowerLevelsEventContent(), PowerLevelsEventContent(users = mapOf(alice to 42L)))
        delay(500.milliseconds)
        assertNotNull(model.changeMessage.value)
    }
    ...
    private fun TestScope.testModel(
        ...
        val model =
            PowerLevelsTimelineElementViewModelFactoryImpl(
                viewModelContext =
