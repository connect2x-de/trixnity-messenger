...
class CanonicalAliasStateTimelineElementViewModelTest {
    ...
    fun `display main alias switch`() = runTest {
        val cut =
            roomAliasChangeStatusViewModel(
                previousEventContent = CanonicalAliasEventContent(alias = alias2, aliases = setOf(alias1, alias3)),
                eventContent = CanonicalAliasEventContent(alias = alias1, aliases = setOf(alias2, alias3)),
            )

        backgroundScope.launch { cut.changeMessage.collect {} }

        eventually(2.seconds) { cut.changeMessage.value shouldBe listOf(i18n.setAsMainAlias("bob", alias1.full)) }
    }
    ...
    fun `display main alias creation based on alt_alias`() = runTest {
        val cut =
            roomAliasChangeStatusViewModel(
                previousEventContent = CanonicalAliasEventContent(alias = null, aliases = setOf(alias1, alias2)),
                eventContent = CanonicalAliasEventContent(alias = alias1, aliases = setOf(alias2)),
            )
        backgroundScope.launch { cut.changeMessage.collect {} }
    ...
    fun `display main alias creation out of nowhere`() = runTest {
        val cut =
            roomAliasChangeStatusViewModel(
                previousEventContent = CanonicalAliasEventContent(alias = null, aliases = setOf(alias2)),
                eventContent = CanonicalAliasEventContent(alias = alias1, aliases = setOf(alias2)),
            )
        backgroundScope.launch { cut.changeMessage.collect {} }
    ...
    fun `display main alias removal`() = runTest {
        val cut =
            roomAliasChangeStatusViewModel(
                previousEventContent = CanonicalAliasEventContent(alias = alias2, aliases = setOf(alias1, alias3)),
                eventContent = CanonicalAliasEventContent(alias = null, aliases = setOf(alias2, alias1, alias3)),
            )
        backgroundScope.launch { cut.changeMessage.collect {} }

        eventually(2.seconds) { cut.changeMessage.value shouldBe listOf(i18n.removeAsMainAlias("bob", alias2.full)) }
    }
    ...
    fun `display main alias deletion`() = runTest {
        val cut =
            roomAliasChangeStatusViewModel(
                previousEventContent = CanonicalAliasEventContent(alias = alias2, aliases = setOf(alias1, alias3)),
                eventContent = CanonicalAliasEventContent(alias = null, aliases = setOf(alias1, alias3)),
            )
        backgroundScope.launch { cut.changeMessage.collect {} }

        eventually(2.seconds) { cut.changeMessage.value shouldBe listOf(i18n.removedAlias("bob", alias2.full)) }
    }
    ...
    fun `display added alias`() = runTest {
        val cut =
            roomAliasChangeStatusViewModel(
                previousEventContent = CanonicalAliasEventContent(alias = alias2, aliases = setOf(alias1, alias3)),
                eventContent = CanonicalAliasEventContent(alias = alias2, aliases = setOf(alias1, alias3, alias4)),
            )
        backgroundScope.launch { cut.changeMessage.collect {} }

        eventually(2.seconds) { cut.changeMessage.value shouldBe listOf(i18n.addedAlias("bob", alias4.full)) }
    }
    ...
    fun `display added aliases`() = runTest {
        val cut =
            roomAliasChangeStatusViewModel(
                previousEventContent = CanonicalAliasEventContent(alias = alias2, aliases = setOf(alias1, alias3)),
                eventContent =
                    CanonicalAliasEventContent(alias = alias2, aliases = setOf(alias1, alias3, alias4, alias5)),
            )
        backgroundScope.launch { cut.changeMessage.collect {} }

        eventually(2.seconds) {
            cut.changeMessage.value shouldBe
                listOf(i18n.addedAlias("bob", alias4.full), i18n.addedAlias("bob", alias5.full))
        }
    }
        ...
        val cut =
            roomAliasChangeStatusViewModel(
                previousEventContent =
                    CanonicalAliasEventContent(alias = alias2, aliases = setOf(alias1, alias3, alias4)),
                eventContent = CanonicalAliasEventContent(alias = alias2, aliases = setOf(alias1, alias3)),
            )
        backgroundScope.launch { cut.changeMessage.collect {} }

        eventually(2.seconds) { cut.changeMessage.value shouldBe listOf(i18n.removedAlias("bob", alias4.full)) }
    }
    ...
    fun `display removed aliases`() = runTest {
        ...
        eventually(2.seconds) {
            cut.changeMessage.value shouldBe
                listOf(i18n.removedAlias("bob", alias4.full), i18n.removedAlias("bob", alias5.full))
        }
    }
    ...
    fun `do nothing when nothing changed`() = runTest {
        ...
        eventually(2.seconds) { cut.changeMessage.value shouldBe listOf() }
    }
                ...
                TimelineEvent(
                    event =
                        StateEvent(
                            ...
                            originTimestamp = 0L,
                            unsigned =
                                UnsignedRoomEventData.UnsignedStateEventData(previousContent = previousEventContent),
                            stateKey = "",
                        ),
