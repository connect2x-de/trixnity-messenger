...
import de.connect2x.messenger.compose.view.uia.UiaActionConfirmation
import de.connect2x.messenger.compose.view.uia.UiaDummyStep
import de.connect2x.messenger.compose.view.uia.UiaFallbackFlow
import de.connect2x.messenger.compose.view.uia.UiaPasswordInput
import de.connect2x.messenger.compose.view.uia.UiaRegistrationToken
...
private fun UiaUserConfirmationPreview() {
    InitMessengerPreview {
        UiaActionConfirmation(UiaActionConfirmationViewModelPreview())
    }
}
...
private fun UiaUserConfirmationErrorPreview() {
    InitMessengerPreview {
        UiaActionConfirmation(UiaActionConfirmationViewModelPreview(ERROR))
    }
}
...
private fun RegistrationTokenPreview() {
    InitMessengerPreview {
        UiaRegistrationToken(UiaStepRegistrationTokenViewModelPreview())
    }
}
...
private fun PasswordInputPreview() {
    InitMessengerPreview {
        UiaPasswordInput(UiaStepPasswordViewModelPreview())
    }
}
...
private fun PasswordInputPreviewFilledOut() {
    InitMessengerPreview {
        UiaPasswordInput(UiaStepPasswordViewModelPreview(FILLED))
    }
}
...
private fun PasswordInputPreviewError() {
    InitMessengerPreview {
        UiaPasswordInput(UiaStepPasswordViewModelPreview(PASSWORD_ERROR))
    }
}
...
private fun PasswordInputPreviewSubmitting() {
    InitMessengerPreview {
        UiaPasswordInput(UiaStepPasswordViewModelPreview(SUBMITTING))
    }
}
...
private fun FallbackFlowPreview() {
    InitMessengerPreview {
        UiaFallbackFlow(UiaStepFallbackViewModelPreview())
    }
}
...
private fun FallbackFlowPreviewAwaiting() {
    InitMessengerPreview {
        UiaFallbackFlow(UiaStepFallbackViewModelPreview(AWAITING))
    }
}
...
private fun FallbackFlowPreviewError() {
    InitMessengerPreview {
        UiaFallbackFlow(UiaStepFallbackViewModelPreview(FALLBACK_ERROR))
    }
}
...
private fun DummyFlowPreview() {
    InitMessengerPreview {
        UiaDummyStep(UiaStepDummyViewModelPreview())
    }
}
