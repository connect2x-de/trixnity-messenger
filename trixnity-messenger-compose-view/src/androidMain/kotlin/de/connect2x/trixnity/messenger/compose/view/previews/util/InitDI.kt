...
internal fun InitMessengerPreview(
    ...
    CompositionLocalProvider(
        ...
        ) { // TODO we have to disable our own typography here, since there is a bug in compose resources
    ...
    val koinApplication = koinApplication {
        modules(
            module {
                ...
                single<MatrixMultiMessengerConfiguration> { MatrixMultiMessengerConfiguration() }
                single<GetSystemLang> { GetSystemLang { "de" } }
