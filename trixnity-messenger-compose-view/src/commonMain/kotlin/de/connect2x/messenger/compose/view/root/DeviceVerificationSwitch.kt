...
import de.connect2x.messenger.compose.view.verification.DeviceVerificationModal
...
fun DeviceVerificationSwitch(mainViewModel: MainViewModel) {
    Children(stack = mainViewModel.deviceVerificationRouterStack) {
        when (val child = it.instance) {
            is VerificationRouter.Wrapper.Verification -> DeviceVerificationModal(child.viewModel)
