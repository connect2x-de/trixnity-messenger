...
import de.connect2x.messenger.compose.view.room.settings.DevInfoView
import de.connect2x.messenger.compose.view.room.settings.DevInfoViewImpl
...
fun roomSettingsViewModule(features: MatrixMessengerConfiguration.Features? = null) = module {
    ...
    single<DevInfoView> { DevInfoViewImpl() }
