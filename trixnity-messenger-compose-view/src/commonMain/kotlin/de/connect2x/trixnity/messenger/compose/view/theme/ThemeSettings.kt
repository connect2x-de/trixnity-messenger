...
@Immutable
data class ThemeSettings(val themeMode: ThemeMode, val isHighContrast: Boolean, val accentColor: Color?) {
    @Composable
...
val CurrentThemeSettings: ThemeSettings
    ...
    get() =
        DI.getOrNull<MatrixMessengerSettingsHolder>()
            ...
            ?.collectAsState(null)
            ?.value ?: ThemeSettings(ThemeMode.DEFAULT, false, null)

@Composable expect fun isDarkTheme(): Boolean
