...
internal class CreateNewChatEntry : NavigationEntry<CreateNewChatRoute> {

    override val metadata: Map<String, Any> = TwoPaneScene.left() + ThreePaneScene.left()

    @Composable
    override fun Content(route: CreateNewChatRoute) {
        CreateNewChat(createNewChatViewModel = rememberComponent<CreateNewChatViewModel>())
    }
}
