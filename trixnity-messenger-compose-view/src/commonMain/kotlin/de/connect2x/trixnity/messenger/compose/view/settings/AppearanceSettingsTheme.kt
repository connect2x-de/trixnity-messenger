...
class AppearanceSettingsThemeViewImpl : AppearanceSettingsThemeView {
    ...
    override fun ColumnScope.create(appearanceSettingsViewModel: AppearanceSettingsViewModel) {
        ...
        RadioSetting(
            ...
            options =
                mapOf(
                    ThemeMode.DEFAULT to
                        RadioSettingOption(i18n.appearanceThemeDefaultHeading(), i18n.appearanceThemeDefaultHeading()),
                    ThemeMode.LIGHT to
                        RadioSettingOption(i18n.appearanceThemeLightHeading(), i18n.appearanceThemeLightExplanation()),
                    ThemeMode.DARK to
                        RadioSettingOption(i18n.appearanceThemeDarkHeading(), i18n.appearanceThemeDarkExplanation()),
                ),
            value = themeMode,
