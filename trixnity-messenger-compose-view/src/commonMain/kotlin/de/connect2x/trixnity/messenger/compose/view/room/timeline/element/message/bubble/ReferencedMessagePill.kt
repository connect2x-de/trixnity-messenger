...
interface ReferencedMessagePillView {
    @Composable
    fun create(
...
fun ReferencedMessagePill(
    ...
    DI.get<ReferencedMessagePillView>().create(holder, element, modifier, interactionSource, content)
}

class ReferencedMessagePillViewImpl : ReferencedMessagePillView {
    @Composable
    override fun create(
        holder: TimelineElementHolderViewModel,
        element: TimelineElementViewModel<*>,
