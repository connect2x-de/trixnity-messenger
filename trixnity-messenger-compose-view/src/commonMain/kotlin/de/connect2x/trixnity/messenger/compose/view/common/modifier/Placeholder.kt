...
/**
 * Contains default values used by [Modifier.placeholder] and [de.connect2x.trixnity.messenger.compose.view.common.modifier.PlaceholderHighlight].
 */
object PlaceholderDefaults {
    /**
     * The default [InfiniteRepeatableSpec] to use for [de.connect2x.trixnity.messenger.compose.view.common.modifier.fade].
     */
    ...
    /**
     * The default [InfiniteRepeatableSpec] to use for [de.connect2x.trixnity.messenger.compose.view.common.modifier.shimmer].
     */
 ...
 * The [de.connect2x.trixnity.messenger.compose.view.common.modifier.shimmer] and [de.connect2x.trixnity.messenger.compose.view.common.modifier.fade] implementations are provided for easy usage.
 *
