...
data class ChipStyle(
    ...
    data class Elevation(
        ...
        fun forStaticChip() = ChipElevation(elevation, elevation, elevation, elevation, elevation, elevation)
    ...
    data class Colors(
        ...
        companion object {
            ...
            private val DisabledLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurface

            private const val DisabledLabelTextOpacity = 0.38f
            private val ElevatedDisabledContainerColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurface

            private const val ElevatedDisabledContainerOpacity = 0.12f
            private val ElevatedSelectedContainerColor: Color
                @Composable get() = MaterialTheme.colorScheme.secondaryContainer

            private val ElevatedUnselectedContainerColor: Color
                @Composable get() = MaterialTheme.colorScheme.surfaceContainerLow

            private val FlatDisabledSelectedContainerColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurface

            private const val FlatDisabledSelectedContainerOpacity = 0.12f
            private val FlatDisabledUnselectedOutlineColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurface

            private const val FlatDisabledUnselectedOutlineOpacity = 0.12f
            private val FlatSelectedContainerColor: Color
                @Composable get() = MaterialTheme.colorScheme.secondaryContainer

            private val FlatUnselectedFocusOutlineColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

            private val FlatUnselectedOutlineColor: Color
                @Composable get() = MaterialTheme.colorScheme.outline

            private val FocusIndicatorColor: Color
                @Composable get() = MaterialTheme.colorScheme.secondary

            private val SelectedDraggedLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedFocusLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedHoverLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedPressedLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val UnselectedDraggedLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

            private val UnselectedFocusLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

            private val UnselectedHoverLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

            private val UnselectedLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

            private val UnselectedPressedLabelTextColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant
            ...
            private val SelectedDraggedLeadingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedFocusLeadingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedHoverLeadingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedLeadingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedPressedLeadingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val UnselectedDraggedLeadingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.primary

            private val UnselectedFocusLeadingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.primary

            private val UnselectedHoverLeadingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.primary

            private val UnselectedLeadingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.primary

            private val UnselectedPressedLeadingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.primary
            ...
            private val SelectedDraggedTrailingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedFocusTrailingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedHoverTrailingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedPressedTrailingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val SelectedTrailingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSecondaryContainer

            private val UnselectedDraggedTrailingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

            private val UnselectedFocusTrailingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

            private val UnselectedHoverTrailingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

            private val UnselectedPressedTrailingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

            private val UnselectedTrailingIconColor: Color
                @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant
            ...
            fun default(
                ...
                disabledSelectedContainerColor: Color =
                    FlatDisabledSelectedContainerColor.copy(alpha = FlatDisabledSelectedContainerOpacity),
            ...
            fun elevated(
                ...
                disabledContainerColor: Color =
                    ElevatedDisabledContainerColor.copy(alpha = ElevatedDisabledContainerOpacity),
                disabledLabelColor: Color = DisabledLabelTextColor.copy(alpha = DisabledLabelTextOpacity),
                disabledLeadingIconColor: Color = DisabledLeadingIconColor.copy(alpha = DisabledLeadingIconOpacity),
                disabledTrailingIconColor: Color = DisabledTrailingIconColor.copy(alpha = DisabledTrailingIconOpacity),
    ...
    fun border(enabled: Boolean, selected: Boolean = false, hasFocus: Boolean = false) =
        when {
    ...
    companion object {
        ...
        ) = ChipStyle(shape, colors, elevation, enabledBorder, selectedBorder, disabledBorder, focusedBorder)
...
fun ThemedAssistChip(
    ...
    AssistChip(
        onClick,
        label,
        modifier.onFocusChanged { hasFocus.value = it.hasFocus },
        enabled,
        leadingIcon,
        trailingIcon,
        style.shape,
...
fun ThemedInfoChip(
    ...
    SuggestionChip(
        onClick = {},
        label = label,
        modifier = modifier.onFocusChanged { hasFocus.value = it.hasFocus },
        enabled = false,
        icon = icon,
        shape = style.shape,
