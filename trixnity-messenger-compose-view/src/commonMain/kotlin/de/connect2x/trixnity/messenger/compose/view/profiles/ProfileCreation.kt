...
fun ProfileCreation(
    ...
    onFinish: () -> Unit,
    onCreate: () -> Unit,
    canCreateProfile: Boolean = (error == null),
) {
    DI.get<ProfileCreationView>().create(textFieldViewModel, error, onFinish, onCreate, canCreateProfile)
}
...
class ProfileCreationViewImpl : ProfileCreationView {
    ...
    override fun create(
        ...
        var profileName by textFieldViewModel.collectAsTextFieldValueState()
        val error = error
