...
internal class CreateNewGroupEntry : NavigationEntry<CreateNewGroupRoute> {

    override val metadata: Map<String, Any> = TwoPaneScene.left() + ThreePaneScene.left()

    @Composable
    override fun Content(route: CreateNewGroupRoute) {
        CreateNewGroup(createNewGroupViewModel = rememberComponent<CreateNewGroupViewModel>())
    }
}
