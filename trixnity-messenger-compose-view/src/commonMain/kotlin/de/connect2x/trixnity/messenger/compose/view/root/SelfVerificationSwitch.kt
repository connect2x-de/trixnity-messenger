...
import de.connect2x.trixnity.messenger.compose.view.verification.v2.SelfVerificationWizard
...
fun SelfVerificationSwitch(mainViewModel: MainViewModel) {
    Children(stack = mainViewModel.selfVerificationStack) {
        when (val child = it.instance) {
            ...
            is SelfVerificationRouter.Wrapper.ViewV2 -> SelfVerificationWizard(child.viewModel)
            is SelfVerificationRouter.Wrapper.RedoSelfVerification -> RedoSelfVerificationWizard(child.viewModel)
