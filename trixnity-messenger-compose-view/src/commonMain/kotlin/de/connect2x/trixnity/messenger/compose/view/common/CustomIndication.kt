...
data class CustomIndicationElement(val interactionSource: InteractionSource, val factory: IndicationNodeFactory) :
...
data class CustomIndicationNode(private var delegate: DelegatableNode) : DelegatingNode() {
    init {
        delegate(delegate)
    }
