...
@Composable
fun MaterialThemeComponents(componentStyles: ThemeComponents, content: @Composable () -> Unit) {
    // We need this double nesting to set a specific LocalContent color
    val contentColor = LocalContentColor.current
    CompositionLocalProvider(LocalContentColor provides Color.LocalContent) {
        val components = componentStyles.create()
        ApplySystemUiTheme(components.systemUi)
        CompositionLocalProvider(LocalComponentStyles provides components, LocalContentColor provides contentColor) {
            content()
        }
    }
}
...
interface ThemeComponents {
    @Composable fun create(): ComponentStyles
}
...
class ThemeComponentsImpl : ThemeComponents {
    ...
    private fun focusedBorder(color: Color, defaultBorder: BorderStroke? = null): BorderStroke? =
        if (IsFocusHighlighting.current) {
            BorderStroke(width = MaterialTheme.messengerFocusIndicator.borderWidth, color = color)
        } else defaultBorder
    ...
    override fun create(): ComponentStyles =
        ComponentStyles(
            // system
            systemUi =
                SystemUiStyle.default(
            ...
            commonIconButton =
                IconButtonStyle.default(
                    colors = IconButtonDefaults.iconToggleButtonColors(contentColor = Color.LocalContent),
            ...
            sidebar =
                SurfaceStyle.default(color = MaterialTheme.colorScheme.surfaceContainerLow, tonalElevation = 4.dp),
            details =
                SurfaceStyle.default(color = MaterialTheme.colorScheme.surfaceContainerLow, tonalElevation = 4.dp),
            header = SurfaceStyle.default(color = MaterialTheme.colorScheme.surface, tonalElevation = 8.dp),
            ...
            roomListDivider = DividerStyle.default(padding = PaddingValues(horizontal = 10.dp)),
            accountSelector =
                ButtonStyle.filled(
            ...
            // input area
            inputAreaSurface = SurfaceStyle.default(color = MaterialTheme.colorScheme.surface, tonalElevation = 8.dp),
            inputArea =
                InputAreaStyle.default(
                    ...
                    colors =
                        TextFieldDefaults.colors(
                            ...
                            errorIndicatorColor =
                                if (IsFocusHighlighting.current) MaterialTheme.colorScheme.error else Color.Transparent,
            ...
            // file viewer
            fileViewerSurface = SurfaceStyle.default(color = Color.Black, contentColor = Color.LightGray),
            fileViewerIconButton =
                IconButtonStyle.filled(
                    colors =
            ...
            smallCircularProgressIndicator = CircularProgressIndicatorStyle.default(size = 32.dp),
            extraSmallCircularProgressIndicator = CircularProgressIndicatorStyle.default(size = 24.dp),
            switchProgressIndicator = CircularProgressIndicatorStyle.default(size = 24.dp, strokeWidth = 2.dp),
            ...
            // other
            settingsItem = ListItemStyle.default(colors = ListItemDefaults.colors(containerColor = Color.Transparent)),
            library =
                LibraryStyle.default(
                    colors =
