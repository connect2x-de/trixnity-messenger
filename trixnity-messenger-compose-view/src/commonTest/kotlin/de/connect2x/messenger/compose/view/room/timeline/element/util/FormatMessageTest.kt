...
class FormatMessageTest {
    ...
    fun shouldReplaceBasicUserMention() {
        ...
        val mention = listOf(Pair(6..19, MessageMention.User(UserInfoElement("user", UserId("user", "acme.org")))))
    ...
    fun shouldReplaceUriUserMention() {
        ...
        val mention = listOf(Pair(6..39, MessageMention.User(UserInfoElement("user", UserId("user", "acme.org")))))
    ...
    fun shouldReplaceLinkUserMention() {
        ...
        val mention = listOf(Pair(6..47, MessageMention.User(UserInfoElement("user", UserId("user", "acme.org")))))
    ...
    fun shouldReplaceMultipleMentions() {
        ...
        val mention = listOf(
            56..70 to MessageMention.User(UserInfoElement("user2", UserId("user2", "acme.org"))),
            6..19 to MessageMention.User(UserInfoElement("user", UserId("user", "acme.org")))
        )
