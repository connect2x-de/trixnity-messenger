...
@file:Suppress("PropertyName", "LocalVariableName", "FunctionName", "unused", "NOTHING_TO_INLINE", "DuplicatedCode")
...
@JsExport.Ignore
inline fun RefProxy(num: JsNumber? = null, gen: JsNumber? = null) =
    unsafeJso<RefProxy> {
        num?.let { this.num = it }
        gen?.let { this.gen = it }
    }
...
@JsExport.Ignore
inline fun OnProgressParameters(loaded: JsNumber? = null, total: JsNumber? = null) =
...
@JsExport.Ignore
inline fun GetTextContentParameters(includeMarkedContent: Boolean? = null, disableNormalization: Boolean? = null) =
...
@JsExport.Ignore
inline fun TextContent(items: JsArray<JsAny?>? = null, styles: JsAny? = null, lang: String? = null) =
...
@JsExport.Ignore
inline fun TextMarkedContent(type: String? = null, id: String? = null) =
...
@JsExport.Ignore
inline fun GetAnnotationsParameters(intent: String? = null) =
    unsafeJso<GetAnnotationsParameters> { intent?.let { this.intent = it } }
...
@JsExport.Ignore
inline fun StructTreeNode(children: JsArray<StructTreeElement>? = null, role: String? = null) =
...
@JsExport.Ignore
inline fun StructTreeContent(type: String? = null, id: String? = null) =
...
@JsExport.Ignore
inline fun PDFOperatorList(fnArray: JsArray<JsNumber>? = null, argsArray: JsArray<JsAny?>? = null) =
...
@JsExport.Ignore
inline fun PDFWorkerParameters(name: String? = null, port: Worker? = null, verbosity: JsNumber? = null) =
...
@JsExport.Ignore
inline fun GetOptionalContentConfigParameters(intent: String? = null) =
    unsafeJso<GetOptionalContentConfigParameters> { intent?.let { this.intent = it } }
