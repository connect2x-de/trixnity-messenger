...
//import de.connect2x.trixnity.messenger.integrationtests.messenger.findMessage
//import de.connect2x.trixnity.messenger.integrationtests.messenger.login
//import de.connect2x.trixnity.messenger.integrationtests.messenger.logout
//import de.connect2x.trixnity.messenger.integrationtests.messenger.sendMessage
...
//        log.info { "--- second client" }
//        messenger2 = createTestMatrixMessenger("client-2")
//        val recoveryKey = messenger2.login(
//            serverUrl = "http://${synapseDocker.host}:${synapseDocker.firstMappedPort}",
//            username = user2,
...
//        delay(2.seconds)
//        messenger2.logout(UserId(user2, "localhost:8008"))
//
//        log.info { "--- create chat and send message" }
//        val roomListElement = messenger1.createChatWithUser(user2)
//        messenger1.sendMessage(roomListElement.roomId, "Hello!")
//
...
//        messenger2.findMessage(roomListElement.roomId, "Hello!") shouldBe false
//    }
//}
