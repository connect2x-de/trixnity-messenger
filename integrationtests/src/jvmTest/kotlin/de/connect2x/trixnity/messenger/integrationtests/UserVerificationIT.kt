...
class UserVerificationIT {
    ...
    fun shouldDoSelfVerificationWithRecoveryKeyAndEmojiCompare(): Unit = runBlockingWithTimeout {
        ...
        messenger1.initiateUserVerification(roomId, userId(user2))
    }

    private fun userId(username: String) = UserId("@$username:${synapseDocker.host}:${synapseDocker.firstMappedPort}")
}
