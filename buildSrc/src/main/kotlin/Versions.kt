...
object Versions {
    const val trixnityMessenger = "2.0.0-beta1"

    val kotlinJvmTarget = JavaVersion.VERSION_11
    const val trixnity = "4.2.5" // https://gitlab.com/trixnity/trixnity/-/releases
    ...
    // integration tests
    const val testContainers = "1.19.4" // https://github.com/testcontainers/testcontainers-java/releases
