...
object Versions {
    ...
    const val trixnity = "4.0.0-SNAPSHOT-b4f8b822" // https://gitlab.com/trixnity/trixnity/-/releases
    ...
    const val decompose = "2.1.3" // https://github.com/arkivanov/Decompose/releases
